    ...
    <div className="pt-20 pb-16 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-16 pt-16 border-t border-white/10">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl sm:text-3xl font-black tracking-tighter uppercase" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                Exit <span className="text-[#D946EF]">Simulator</span>
              </h2>
              <p className="text-slate-500 text-sm mt-1">Monte Carlo simulations for your exit strategy</p>
            </div>
            <div className="flex items-center gap-2">
              {simResults && (
                ...
                <>
                  ...
                  <div className="glass-card rounded-2xl p-6 border border-white/5">
                    ...
                    <div className="h-[300px]">
                      {simTab === "paths" && pathsChart && <LineJS data={pathsChart} options={simChartOpts} />}
                      {simTab === "hist" && histChart && <BarJS data={histChart} options={simChartOpts} />}
                    </div>
                  </div>
