        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              {[{t:"Betting Arena",p:"/betting"},{t:"Plushie Shop",p:"/shop"},{t:"Speed Run",p:"/game"},{t:"Exit Simulator",p:"/exit-simulator"}].map(l=>(
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to="/wallet" className="text-sm text-slate-500 hover:text-white transition-colors">Wallet Dashboard</Link>
            </div>
          </div>
