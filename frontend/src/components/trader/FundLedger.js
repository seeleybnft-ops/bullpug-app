...
import { Wallet, ArrowUpRight, ArrowDownRight, Lock, RefreshCw, History, ChevronDown, ChevronUp, Copy, ArrowRight } from "lucide-react";
            ...
            <div className="flex md:flex-col gap-2 min-w-[140px]">
              ...
              <Button
                onClick={() => {
                  ...
                  if (amount && parseFloat(amount) > 0 && onWithdraw) {
