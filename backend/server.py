...
# ========== P2P POT SYSTEM - MOVED TO routers/pot.py ==========
# State now managed in state/pot_state.py
...
# ========== Reflections Calculator - MOVED TO routers/reflections.py ==========
...
# ========== ADMIN PANEL - MOVED TO routers/admin.py ==========
